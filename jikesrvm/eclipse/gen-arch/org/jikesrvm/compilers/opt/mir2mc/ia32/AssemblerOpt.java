...
public abstract class AssemblerOpt extends AssemblerBase {
    ...
    if (isImm(MIR_BinaryAcc.getValue(inst))) {
      if (isByte(inst)) {
        if (isGPR_Reg(MIR_BinaryAcc.getResult(inst))) {
          if (VM.VerifyAssertions && !(getGPR_Reg(MIR_BinaryAcc.getResult(inst)).value() < 4)) VM._assert(false, inst.toString());
      ...
      if (isByte(inst)) {
        if (isGPR_Reg(MIR_BinaryAcc.getResult(inst))) {
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_BinaryAcc.getValue(inst))) VM._assert(false, inst.toString());
          if (VM.VerifyAssertions && !(getGPR_Reg(MIR_BinaryAcc.getResult(inst)).value() < 4)) VM._assert(false, inst.toString());
          if (VM.VerifyAssertions && !(getGPR_Reg(MIR_BinaryAcc.getValue(inst)).value() < 4)) VM._assert(false, inst.toString());
  ...
  private void doFSUBRP(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_BinaryAcc.getResult(inst))) VM._assert(false, inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_BinaryAcc.getValue(inst))) VM._assert(false, inst.toString());
    emitFSUBRP_Reg_Reg(
  ...
  private void doCMPXCHG(Instruction inst) {
    if (isQuad(inst)) {
      if (isGPR_Reg(MIR_CompareExchange.getMemAddr(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_CompareExchange.getNewValue(inst))) VM._assert(false, inst.toString());
  ...
  private void doBTC(Instruction inst) {
    if (isImm(MIR_Test.getVal2(inst))) {
      ...
      if (isGPR_Reg(MIR_Test.getVal1(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Test.getVal2(inst))) VM._assert(false, inst.toString());
        emitBTC_Reg_Reg(
          getGPR_Reg(MIR_Test.getVal1(inst)),
  ...
  private void doFST(Instruction inst) {
    if (isQuad(inst)) {
      if (isAbs(MIR_Move.getResult(inst))) {
        if (VM.VerifyAssertions && !isFPR_Reg(MIR_Move.getValue(inst))) VM._assert(false, inst.toString());
  ...
  private void doCMPEQSS(Instruction inst) {
    if (isXMM_Reg(MIR_BinaryAcc.getValue(inst))) {
      if (VM.VerifyAssertions && !isXMM_Reg(MIR_BinaryAcc.getResult(inst))) VM._assert(false, inst.toString());
      emitCMPEQSS_Reg_Reg(
  ...
  private void doFLD(Instruction inst) {
    if (isQuad(inst)) {
      if (isAbs(MIR_Move.getValue(inst))) {
        if (VM.VerifyAssertions && !isFPR_Reg(MIR_Move.getResult(inst))) VM._assert(false, inst.toString());
  ...
  private void doFLD1(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_Nullary.getResult(inst))) VM._assert(false, inst.toString());
    emitFLD1_Reg(
  ...
  private void doFCOMIP(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_Compare.getVal1(inst))) VM._assert(false, inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_Compare.getVal2(inst))) VM._assert(false, inst.toString());
    emitFCOMIP_Reg_Reg(
  ...
  private void doNOT(Instruction inst) {
    if (isByte(inst)) {
      if (isGPR_Reg(MIR_UnaryAcc.getResult(inst))) {
        if (VM.VerifyAssertions && !(getGPR_Reg(MIR_UnaryAcc.getResult(inst)).value() < 4)) VM._assert(false, inst.toString());
        emitNOT_Reg_Byte(
  ...
  private void doMOV(Instruction inst) {
    if (isGPR_Reg(MIR_Move.getResult(inst))) {
      if (isQuad(inst)) {
        ...
        if (isByte(inst)) {
          if (isGPR_Reg(MIR_Move.getValue(inst))) {
            if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Move.getResult(inst)).value() < 4)) VM._assert(false, inst.toString());
            if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Move.getValue(inst)).value() < 4)) VM._assert(false, inst.toString());
      ...
      if (isImm(MIR_Move.getValue(inst))) {
        ...
        if (isByte(inst)) {
          if (isAbs(MIR_Move.getResult(inst))) {
            if (VM.VerifyAssertions && !isGPR_Reg(MIR_Move.getValue(inst))) VM._assert(false, inst.toString());
            if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Move.getValue(inst)).value() < 4)) VM._assert(false, inst.toString());
  ...
  private void doMOVSXQ(Instruction inst) {
    if (isByte(inst)) {
      if (isGPR_Reg(MIR_Unary.getVal(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Unary.getResult(inst))) VM._assert(false, inst.toString());
  ...
  private void doCVTSI2SDQ(Instruction inst) {
    if (isGPR_Reg(MIR_Unary.getVal(inst))) {
      if (VM.VerifyAssertions && !isXMM_Reg(MIR_Unary.getResult(inst))) VM._assert(false, inst.toString());
      if (VM.VerifyAssertions && !isQuad(inst)) VM._assert(false, inst.toString());
    ...
    if (isQuad(inst)) {
      if (isImm(MIR_DoubleShift.getBitsToShift(inst))) {
        if (isGPR_Reg(MIR_DoubleShift.getResult(inst))) {
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_DoubleShift.getSource(inst))) VM._assert(false, inst.toString());
        ...
        if (isGPR_Reg(MIR_DoubleShift.getResult(inst))) {
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_DoubleShift.getSource(inst))) VM._assert(false, inst.toString());
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_DoubleShift.getBitsToShift(inst))) VM._assert(false, inst.toString());
  ...
  private void doMUL(Instruction inst) {
    if (isQuad(inst)) {
      if (isGPR_Reg(MIR_Multiply.getValue(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Multiply.getResult2(inst))) VM._assert(false, inst.toString());
  ...
  private void doMETHODSTART(Instruction inst) {
    if (VM.VerifyAssertions && !isGPR_Reg(MIR_Nullary.getResult(inst))) VM._assert(false, inst.toString());
    emitMETHODSTART_Reg(
      getGPR_Reg(MIR_Nullary.getResult(inst)));
  }
  ...
  private void doMOVLPD(Instruction inst) {
    if (isXMM_Reg(MIR_Move.getResult(inst))) {
      ...
      if (isAbs(MIR_Move.getResult(inst))) {
        if (VM.VerifyAssertions && !isXMM_Reg(MIR_Move.getValue(inst))) VM._assert(false, inst.toString());
        emitMOVLPD_Abs_Reg(
          getDisp(MIR_Move.getResult(inst)).toWord().toAddress(),
          getXMM_Reg(MIR_Move.getValue(inst)));
    ...
    if (isGPR_Reg(MIR_Compare.getVal1(inst))) {
      if (isByte(inst)) {
        if (isImm(MIR_Compare.getVal2(inst))) {
          if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Compare.getVal1(inst)).value() < 4)) VM._assert(false, inst.toString());
          ...
          if (isGPR_Reg(MIR_Compare.getVal2(inst))) {
            if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Compare.getVal1(inst)).value() < 4)) VM._assert(false, inst.toString());
            if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Compare.getVal2(inst)).value() < 4)) VM._assert(false, inst.toString());
      ...
      if (isImm(MIR_Compare.getVal2(inst))) {
        ...
        if (isByte(inst)) {
          if (isAbs(MIR_Compare.getVal1(inst))) {
            if (VM.VerifyAssertions && !isGPR_Reg(MIR_Compare.getVal2(inst))) VM._assert(false, inst.toString());
            if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Compare.getVal2(inst)).value() < 4)) VM._assert(false, inst.toString());
  ...
  private void doTEST(Instruction inst) {
    if (isImm(MIR_Test.getVal2(inst))) {
      if (isByte(inst)) {
        if (isGPR_Reg(MIR_Test.getVal1(inst))) {
          if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Test.getVal1(inst)).value() < 4)) VM._assert(false, inst.toString());
      ...
      if (isByte(inst)) {
        if (isGPR_Reg(MIR_Test.getVal1(inst))) {
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_Test.getVal2(inst))) VM._assert(false, inst.toString());
          if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Test.getVal1(inst)).value() < 4)) VM._assert(false, inst.toString());
          if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Test.getVal2(inst)).value() < 4)) VM._assert(false, inst.toString());
  ...
  private void doBSWAP(Instruction inst) {
    if (isQuad(inst)) {
      if (VM.VerifyAssertions && !isGPR_Reg(MIR_UnaryAcc.getResult(inst))) VM._assert(false, inst.toString());
      emitBSWAP_Reg_Quad(
        getGPR_Reg(MIR_UnaryAcc.getResult(inst)));
  ...
  private void doFXCH(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_XChng.getVal1(inst))) VM._assert(false, inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_XChng.getVal2(inst))) VM._assert(false, inst.toString());
    emitFXCH_Reg_Reg(
  ...
  private void doIMUL2(Instruction inst) {
    if (isQuad(inst)) {
      if (isImm(MIR_BinaryAcc.getValue(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_BinaryAcc.getResult(inst))) VM._assert(false, inst.toString());
  ...
  private void doIDIV(Instruction inst) {
    if (isQuad(inst)) {
      if (isGPR_Reg(MIR_Divide.getValue(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Divide.getResult2(inst))) VM._assert(false, inst.toString());
  ...
  private void doUCOMISD(Instruction inst) {
    if (isXMM_Reg(MIR_Compare.getVal2(inst))) {
      if (VM.VerifyAssertions && !isXMM_Reg(MIR_Compare.getVal1(inst))) VM._assert(false, inst.toString());
      emitUCOMISD_Reg_Reg(
  ...
  private void doFCMOV(Instruction inst) {
    ...
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_CondMove.getResult(inst))) VM._assert(false, inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_CondMove.getValue(inst))) VM._assert(false, inst.toString());
  ...
  private void doSET(Instruction inst) {
    if (isGPR_Reg(MIR_Set.getResult(inst))) {
      ...
      if (VM.VerifyAssertions && !(getGPR_Reg(MIR_Set.getResult(inst)).value() < 4)) VM._assert(false, inst.toString());
  ...
  private void doPREFETCHNTA(Instruction inst) {
    if (VM.VerifyAssertions && !isRegInd(MIR_CacheOp.getAddress(inst))) VM._assert(false, inst.toString());
    emitPREFETCHNTA_RegInd(
      getBase(MIR_CacheOp.getAddress(inst)));
  }
  ...
  private void doLEA(Instruction inst) {
    if (isQuad(inst)) {
      if (isAbs(MIR_Lea.getValue(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Lea.getResult(inst))) VM._assert(false, inst.toString());
  ...
  private void doCMOV(Instruction inst) {
    if (isGPR_Reg(MIR_CondMove.getValue(inst))) {
      if (VM.VerifyAssertions && !isCond(MIR_CondMove.getCond(inst))) VM._assert(false, inst.toString());
      if (VM.VerifyAssertions && !isGPR_Reg(MIR_CondMove.getResult(inst))) VM._assert(false, inst.toString());
