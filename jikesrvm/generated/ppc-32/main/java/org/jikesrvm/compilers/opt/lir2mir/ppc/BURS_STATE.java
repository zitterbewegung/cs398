...
static BURS_TreeNode kids(BURS_TreeNode p, int eruleno, int kidnumber)  { 
	...
	case 258: // r: REF_MOVE(ADDRESS_CONSTANT)
	case 236: // r: LONG_MOVE(LONG_CONSTANT)
	...
	case 2: // r: REGISTER
		break;
	case 268: // r: ATTEMPT_ADDR(r,r)
	case 267: // r: PREPARE_ADDR(r,r)
	case 263: // r: LONG_LOAD(r,r)
	case 239: // stm: LONG_IFCMP(r,r)
	case 238: // stm: LONG_CMP(r,r)
	case 230: // r: LONG_XOR(r,r)
	case 229: // r: LONG_OR(r,r)
	case 228: // r: LONG_AND(r,r)
	case 226: // r: LONG_USHR(r,r)
	case 224: // r: LONG_SHR(r,r)
	case 222: // r: LONG_SHL(r,r)
	case 220: // r: LONG_MUL(r,r)
	case 219: // r: LONG_SUB(r,r)
	case 218: // r: LONG_ADD(r,r)
	...
	case 13: // any: OTHER_OPERAND(any,any)
		...
		break;
	case 262: // r: LONG_LOAD(r,REF_MOVE(ADDRESS_CONSTANT))
	case 261: // r: LONG_LOAD(r,INT_CONSTANT)
	case 257: // r: REF_XOR(r,REF_MOVE(INT_CONSTANT))
	case 256: // r: REF_OR(r,REF_MOVE(INT_CONSTANT))
	case 255: // r: REF_OR(r,REF_MOVE(INT_CONSTANT))
	case 254: // r: REF_AND(r,REF_MOVE(INT_CONSTANT))
	case 253: // czr: REF_AND(r,REF_MOVE(INT_CONSTANT))
	case 237: // r: LONG_MOVE(r)
	case 235: // r: LONG_BITS_AS_DOUBLE(r)
	case 234: // r: DOUBLE_AS_LONG_BITS(r)
	case 233: // r: LONG_2INT(r)
	case 232: // r: INT_2LONG(r)
	case 231: // r: LONG_NOT(r)
	case 227: // r: LONG_USHR(r,INT_CONSTANT)
	case 225: // r: LONG_SHR(r,INT_CONSTANT)
	case 223: // r: LONG_SHL(r,INT_CONSTANT)
	case 221: // r: LONG_NEG(r)
	...
	case 63: // r: REF_SUB(INT_CONSTANT,r)
		...
		break;
	case 250: // stm: INT_IFCMP(REF_ADD(r,INT_CONSTANT),INT_CONSTANT)
	case 249: // stm: INT_IFCMP(REF_AND(r,REF_MOVE(INT_CONSTANT)),INT_CONSTANT)
	case 248: // stm: INT_IFCMP(REF_AND(r,REF_MOVE(INT_CONSTANT)),INT_CONSTANT)
	case 243: // stm: INT_IFCMP(REF_NOT(r),INT_CONSTANT)
	case 242: // stm: INT_IFCMP(REF_NEG(r),INT_CONSTANT)
	...
	case 85: // r: REF_AND(REF_NOT(r),REF_NOT(r))
		...
		break;
	case 265: // stm: LONG_STORE(r,OTHER_OPERAND(r,REF_MOVE(ADDRESS_CONSTANT)))
	case 264: // stm: LONG_STORE(r,OTHER_OPERAND(r,INT_CONSTANT))
	...
	case 241: // stm: INT_IFCMP(ATTEMPT_ADDR(r,r),INT_CONSTANT)
	case 240: // stm: INT_IFCMP(ATTEMPT_INT(r,r),INT_CONSTANT)
	...
	case 111: // r: FLOAT_ADD(FLOAT_MUL(r,r),r)
		...
		break;
	case 266: // stm: LONG_STORE(r,OTHER_OPERAND(r,r))
	...
	case 174: // stm: INT_STORE(r,OTHER_OPERAND(REF_ADD(r,INT_CONSTANT),INT_CONSTANT))
		...
		break;
	case 252: // stm: INT_IFCMP(REF_OR(r,REF_NOT(r)),INT_CONSTANT)
	case 251: // stm: INT_IFCMP(REF_AND(r,REF_NOT(r)),INT_CONSTANT)
		if (kidnumber == 0)  return p.child1.child1;
		if (kidnumber == 1)  return p.child1.child2.child1;
		break;
	}
