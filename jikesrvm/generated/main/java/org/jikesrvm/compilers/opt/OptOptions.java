 ...
 * <p>
 * Note: Boolean options are defined in /home/r2q2/Desktop/cs398/jikesrvm/rvm/src-generated/options/BooleanOptions.opt.dat /home/r2q2/Desktop/cs398/jikesrvm/rvm/src-generated/options/SharedBooleanOptions.dat
 *       All other options are defined in /home/r2q2/Desktop/cs398/jikesrvm/rvm/src-generated/options/ValueOptions.opt.dat /home/r2q2/Desktop/cs398/jikesrvm/rvm/src-generated/options/SharedValueOptions.dat
 ...
 */
   ...
   public boolean SSA_GLOBAL_BOUNDS_CHECK       = false;
   ...
   public boolean PRINT_COALESCING              = false;
   ...
   public boolean PRINT_SCHEDULE_POST           = false;
   ...
   public java.util.Iterator<String> getDRIVER_EXCLUDEs() {
     if (DRIVER_EXCLUDE == null) {
       return new org.jikesrvm.util.EmptyIterator<String>();
     } else {
  ...
  public boolean processAsOption(String prefix, String arg) {
    ...
    if (name.equals("ssa_global_bounds")) {
      if (value.equals("true")) {
        SSA_GLOBAL_BOUNDS_CHECK = true;
        return true;
      } else if (value.equals("false")) {
        SSA_GLOBAL_BOUNDS_CHECK = false;
        return true;
      } else
        return false;
    }
  ...
  public static void printHelp(String prefix) {
    ...
    VM.sysWrite("ssa_global_bounds                      Perform (incomplete/unsafe) global Array Bound Check elimination on Demand\n");
    ...
    VM.sysWrite("print_coal                             Print coalescing output\n");
  ...
  public String toString() {
    ...
    result.append("\tssa_global_bounds              = ").append(SSA_GLOBAL_BOUNDS_CHECK).append("\n");
    ...
    result.append("\tprint_coal                     = ").append(PRINT_COALESCING).append("\n");
  ...
  public void printOptions() {
    ...
    VM.sysWriteln("\tssa_global_bounds              = ",SSA_GLOBAL_BOUNDS_CHECK);
    ...
    VM.sysWriteln("\tprint_coal                     = ",PRINT_COALESCING);
