...
grep -h '^JNIEXPORT .* Java_' /home/r2q2/Desktop/cs398/jikesrvm/components/classpath/97.2p10/classpath/include/*.h | \
...
find /home/r2q2/Desktop/cs398/jikesrvm/components/classpath/97.2p10/classpath/native/jni -name \*.c | \
	xargs grep -h '^Java_' | \
...
find /home/r2q2/Desktop/cs398/jikesrvm/components/classpath/97.2p10/classpath/native/jni -name \*.cpp | \
	xargs grep -h '^Java_' | \
        LC_ALL=C sed -e 's,^\(Java_[a-z_A-Z0-9]*\).*$,\1,' >> $TMPFILE2
find /home/r2q2/Desktop/cs398/jikesrvm/components/classpath/97.2p10/classpath/native/jni -name \*.cpp | \
